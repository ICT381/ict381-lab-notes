...
This lab consists of the following tasks to install the necessary tools.
...
4. Verify that the Homebrew is sucessfully installed by checking its version number. The version number is `6.0.10` at point of writing.
...
4. Install MongoDB Community Server
   ...
   ```
   brew install mongodb-community@7.0 -y
   ```
...
2. (Optional) Install additional exercises for future labs.
