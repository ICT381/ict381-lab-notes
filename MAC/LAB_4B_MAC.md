...
- Completed all the tasks in [LAB_4A_MAC](../MAC/LAB_4A_MAC.md).
...
For detailed steps, refer to [Lab_0C Task 4](../LAB_0C.md#exercise-4-github-ssh-keys).
...
You have completed this lab exercise. Move on to the next exercise for deployment using containers.