...
## Getting Started
To write Markdown, you can use text editor (eg. VSCode, Notepad). Save the file with a `.md` extension. You can try online editor like [Markdown Live Preview](https://markdownlivepreview.com/) for real-time previews.
...
You should have mastered the basics of writing Markdown.